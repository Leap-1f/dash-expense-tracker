                    ...
                    <div className='w-full h-full bg-white centered md:h-screen'>
                        <div className='grid grid-rows-2'>
                            ...
                            <form action="" className='flex flex-col gap-4 text-sm'>
                                <input type="text" className='p-2 rounded-md border mt-8 bg-gray-100' name="Name" placeholder='Name'/>
                                <input type="text" className='p-2 rounded-md border bg-gray-100' name="email" placeholder='Email'/>

                                <input type="password" className='p-2 rounded-md border bg-gray-100' name="password" placeholder='Password'/>
                                <input type="password" className='p-2 rounded-md border bg-gray-100' name="password" placeholder='Re-password'/>
